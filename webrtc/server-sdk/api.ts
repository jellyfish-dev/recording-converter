...
export type ComponentOptionsRecordingSubscribeModeEnum =
  (typeof ComponentOptionsRecordingSubscribeModeEnum)[keyof typeof ComponentOptionsRecordingSubscribeModeEnum];
...
export type ComponentPropertiesRecordingSubscribeModeEnum =
  (typeof ComponentPropertiesRecordingSubscribeModeEnum)[keyof typeof ComponentPropertiesRecordingSubscribeModeEnum];
...
export const RoomApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async subscribeTo(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.subscribeTo(
        roomId,
        componentId,
        subscriptionConfig,
        options,
      ...
      const index = configuration?.serverIndex ?? 0;
      const operationBasePath =
        operationServerMap["RoomApi.subscribeTo"]?.[index]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
